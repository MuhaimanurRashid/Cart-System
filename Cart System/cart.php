     ...
     <div class="table-responsive mt-2">
       <table class="table table-bordered table-striped text-center">
        ...
        <tr>
           ...
           <th>Total Price</th>
           <th>
               <a href="action.php?clear=all" class="badge-danger badge p-1" onclick="return confirm('Are you sure to clear your cart?');">Clear Cart</a>
           </th>
        </tr>
        </thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                   <a href="action.php?remove=<?=$row['id']?>" class="text-danger lead" onclick="return confirm('Are you sure to remove this item?');">Remove Item</a> 
                </td>
            </tr>
            ...
            <?php $grand_total +=$row['total_price'];  ?>
             ...
             <tr>
                 ...
                 <td>
                 <?php if($grand_total>1){echo " <a href='checkout.php' class='btn-btn-info'>Checkout</a>";}else{ echo "No product selected";}?>
                 </td>
             </tr>   
        </tbody>
